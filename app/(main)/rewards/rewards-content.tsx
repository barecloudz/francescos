  ...
  const { data: rewards = [], isLoading: rewardsLoading, error: rewardsError } = useQuery({
    ...
    queryFn: async () => {
      ...
      return data.map((reward: any) => ({
        ...
        free_item_all_from_category: reward.free_item_all_from_category,
        free_item_category: reward.free_item_category,
        free_item_menu_id: reward.free_item_menu_id,
      }));
    },
    enabled: !!user,
  });
                            ...
                            <div className="space-y-2">
                              <div className="bg-blue-50 border border-blue-200 p-3 rounded-lg">
                                <p className="text-sm font-medium text-blue-800 text-center">
                                  Select your free item to use this voucher
                                </p>
                              </div>
                              <Button
                            ...
                            <Button
                              className={`w-full h-12 text-lg font-bold transition-all duration-300 ${
                                isRewardRedeemed(reward.id)
                                  ...
                                  : userData && userData.points >= reward.pointsRequired
                              ...
                              disabled={!userData || userData.points < reward.pointsRequired || redeemRewardMutation.isPending}
                            ...
                            >
                              {redeemRewardMutation.isPending ? (
                                ...
                                <>
                                  ...
                                  Need {reward.pointsRequired - (userData?.points || 0)} more points
                                </>
                              )}
                            </Button>
                          )}
