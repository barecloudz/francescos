...
export const metadata: Metadata = {
  title: "Best Pizza in Murrells Inlet | Francesco's Pizza & Pasta",
  description: "Best pizza in Murrells Inlet! Francesco's Pizza & Pasta offers hand-tossed NY style pizza, pasta, calzones & subs. Family-owned pizzeria on US-17. Order online for pickup!",
