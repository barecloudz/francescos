...
export function DeliverySettings() {
  ...
  return (
    <div className="space-y-6">
          ...
          <form onSubmit={handleUpdateSettings} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                value={process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY || 'Not configured'}
                readOnly
      ...
      {process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY && settings.restaurantAddress && (
        <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      {!process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY && zones.length > 0 && (
        <div className="bg-white p-6 rounded-lg shadow-md">
