...
export function DeliveryMap({ zones, restaurantAddress, onZoneUpdate }: DeliveryMapProps) {
  ...
  useEffect(() => {
    const loadGoogleMaps = () => {
      ...
      script.src = `https://maps.googleapis.com/maps/api/js?key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}&libraries=geometry,marker&callback=${callbackName}&loading=async`;
      script.async = true;
      script.defer = true;
      script.onerror = () => {
