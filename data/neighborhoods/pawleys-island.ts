...
export const pawleysIslandData: NeighborhoodData = {
  ...
  landmarks: ["Pawleys Island Hammock Shops", "Brookgreen Gardens", "Huntington Beach State Park"],
  localAnecdote: "After a visit to Brookgreen Gardens or a walk on Huntington Beach, many Pawleys Island visitors stop at Francesco's for a slice -- it's the perfect end to a Lowcountry day.",
  testimonials: [
    {
      name: "Patricia W.",
      location: "Pawleys Island",
      text: "We live on Pawleys and Francesco's is our go-to for pizza night. The specialty pizzas are incredible.",
      rating: 5
    },
    {
      name: "James H.",
      location: "Pawleys Island",
      text: "Best pizza in the Waccamaw Neck area. We order at least twice a week.",
      rating: 5
    }
  ],
  keywords: ["pizza pawleys island sc", "pizza near pawleys island", "best pizza pawleys island", "italian food pawleys island", "pizza delivery pawleys island"]
};
