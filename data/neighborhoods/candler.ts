...
export const candlerData: NeighborhoodData = {
  ...
  testimonials: [
    ...
    },
    {
      name: "Kevin L.",
      location: "Candler",
      text: "Authentic NY pizza delivered right to Candler. The crust is perfect and they load on the toppings. Highly recommend!",
      rating: 5
    }
  ],
  keywords: [
    "pizza Candler NC",
    "best pizza Candler",
    "pizza delivery Candler",
    "pizza near me Candler",
    "NY pizza Candler",
    "Italian restaurant Candler",
    "pizza Smokey Park Highway"
  ]
};
