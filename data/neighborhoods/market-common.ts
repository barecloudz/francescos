...
export const marketCommonData: NeighborhoodData = {
  ...
  landmarks: ["Market Common shopping district", "Valor Memorial Garden", "Grand Park"],
  localAnecdote: "Market Common residents often pick up Francesco's on their way home from the shops -- our quick online ordering makes it easy to grab pizza without breaking your evening stride.",
  testimonials: [
    {
      name: "Rachel V.",
      location: "Market Common",
      text: "I walk around Market Common all the time, but when I want great pizza, I drive to Francesco's. It's that good.",
      rating: 5
    },
    {
      name: "Greg A.",
      location: "Market Common",
      text: "The specialty gourmet pizzas at Francesco's are restaurant-quality at takeout prices. We're hooked!",
      rating: 5
    }
  ],
  keywords: ["pizza market common myrtle beach", "pizza near market common sc", "best pizza market common", "italian food market common", "pizza delivery market common"]
};
