...
export const bucksportData: NeighborhoodData = {
  ...
  landmarks: ["Bucksport Marina", "Waccamaw River", "Highway 701 corridor"],
  localAnecdote: "Bucksport families heading to Murrells Inlet for an evening out often pick up Francesco's pizza on the way -- it's become a community habit.",
  testimonials: [
    {
      name: "Charlie H.",
      location: "Bucksport",
      text: "Great pizza, great people. Francesco's is our family's regular spot when we head into Murrells Inlet.",
      rating: 5
    },
    {
      name: "Diane R.",
      location: "Bucksport",
      text: "The calzones at Francesco's are the best I've ever had. We drive in from Bucksport every chance we get.",
      rating: 5
    }
  ],
  keywords: ["pizza bucksport sc", "pizza near bucksport", "best pizza bucksport sc", "italian food bucksport", "pizza delivery bucksport sc"]
};
