...
export const murrellsInletData: NeighborhoodData = {
  ...
  landmarks: ["MarshWalk", "Morse Park Landing", "Brookgreen Gardens"],
  localAnecdote: "As Murrells Inlet's newest pizzeria, we're proud to join the rich dining tradition of the Seafood Capital of SC. Our Sicilian heritage meets Southern hospitality right here on US-17.",
  testimonials: [
    {
      name: "Joe T.",
      location: "Murrells Inlet",
      text: "Finally, REAL New York pizza in Murrells Inlet! I don't have to drive anywhere anymore. This is the real deal.",
      rating: 5
    },
    {
      name: "Marie C.",
      location: "Murrells Inlet",
      text: "We live right down the road and eat here multiple times a week. The pasta is incredible and the pizza is perfection.",
      rating: 5
    }
  ],
  keywords: ["pizza murrells inlet sc", "best pizza murrells inlet", "pizza near me murrells inlet", "italian food murrells inlet", "ny style pizza murrells inlet", "pizza delivery murrells inlet"]
};
