...
export const broadwayAtTheBeachData: NeighborhoodData = {
  ...
  landmarks: ["Broadway at the Beach", "WonderWorks", "Ripley's Aquarium"],
  localAnecdote: "Tourists visiting Broadway at the Beach often ask locals for the best pizza recommendation -- and more often than not, they're pointed to Francesco's in Murrells Inlet.",
  testimonials: [
    {
      name: "Mark T.",
      location: "Myrtle Beach visitor",
      text: "A local told us to skip the Broadway restaurants and go to Francesco's. Best advice we got on our whole trip!",
      rating: 5
    },
    {
      name: "Sarah J.",
      location: "Myrtle Beach",
      text: "We come to Broadway for the attractions but always end up at Francesco's for dinner. It's just better.",
      rating: 5
    }
  ],
  keywords: ["pizza broadway at the beach", "pizza near broadway myrtle beach", "best pizza broadway at the beach", "italian food near broadway myrtle beach", "pizza myrtle beach attractions"]
};
