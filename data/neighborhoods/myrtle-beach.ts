...
export const myrtleBeachData: NeighborhoodData = {
  ...
  landmarks: ["Myrtle Beach Boardwalk", "SkyWheel Myrtle Beach", "Myrtle Beach Convention Center"],
  localAnecdote: "Many Myrtle Beach regulars tell us they'd rather make the drive to Murrells Inlet for authentic pizza than settle for tourist-area chains. We're honored by that loyalty.",
  testimonials: [
    {
      name: "Chris L.",
      location: "Myrtle Beach",
      text: "I drive past dozens of pizza places to get to Francesco's. There's no comparison -- this is the real deal.",
      rating: 5
    },
    {
      name: "Amanda B.",
      location: "Myrtle Beach",
      text: "My family moved from New Jersey and we were desperate for real pizza. Francesco's is the answer!",
      rating: 5
    }
  ],
  keywords: ["pizza myrtle beach sc", "best pizza myrtle beach", "ny style pizza myrtle beach", "pizza delivery myrtle beach", "italian food myrtle beach"]
};
