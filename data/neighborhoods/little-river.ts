...
export const littleRiverData: NeighborhoodData = {
  ...
  landmarks: ["Little River Waterfront", "Little River Casino Boats", "La Belle Amie Vineyard"],
  localAnecdote: "Little River fishing families tell us our pizza is the best thing they've found south of the NJ Shore -- high praise from a community that knows good food.",
  testimonials: [
    {
      name: "Wayne D.",
      location: "Little River",
      text: "Worth every mile of the drive. Francesco's pizza is the best thing on the Grand Strand.",
      rating: 5
    },
    {
      name: "Donna K.",
      location: "Little River",
      text: "We order catering from Francesco's for our fishing tournament parties. Everyone loves it!",
      rating: 5
    }
  ],
  keywords: ["pizza little river sc", "pizza near little river", "best pizza little river sc", "italian food little river", "pizza delivery little river sc"]
};
