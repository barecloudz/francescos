...
export const lorisData: NeighborhoodData = {
  ...
  landmarks: ["Loris Bog-Off Festival grounds", "Loris Healthcare", "Downtown Loris"],
  localAnecdote: "Loris families heading to the beach often make Francesco's their first stop -- grabbing pizza for the whole crew before hitting the sand.",
  testimonials: [
    {
      name: "Tommy L.",
      location: "Loris",
      text: "We drive down from Loris every other weekend. Best pizza we've ever had in South Carolina.",
      rating: 5
    },
    {
      name: "Betty J.",
      location: "Loris",
      text: "Our church group ordered catering from Francesco's and everyone was raving about it for weeks!",
      rating: 5
    }
  ],
  keywords: ["pizza loris sc", "pizza near loris south carolina", "best pizza loris sc", "italian food loris", "pizza delivery loris sc"]
};
