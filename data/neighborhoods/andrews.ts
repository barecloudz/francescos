...
export const andrewsData: NeighborhoodData = {
  ...
  landmarks: ["Downtown Andrews", "Andrews Town Hall", "Black River"],
  localAnecdote: "Andrews residents making day trips to the beach frequently stop at Francesco's for dinner on the way home -- our convenient US-17 location makes it an easy detour.",
  testimonials: [
    {
      name: "Earl W.",
      location: "Andrews",
      text: "Every time we head to the coast, we stop at Francesco's. Best pizza between Andrews and the Atlantic!",
      rating: 5
    },
    {
      name: "Martha S.",
      location: "Andrews",
      text: "We ordered catering for my daughter's graduation party. Francesco's made it so easy and the food was amazing.",
      rating: 5
    }
  ],
  keywords: ["pizza andrews sc", "pizza near andrews south carolina", "best pizza andrews sc", "italian food andrews sc", "pizza delivery andrews sc"]
};
