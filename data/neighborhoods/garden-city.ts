...
export const gardenCityData: NeighborhoodData = {
  ...
  landmarks: ["Garden City Pier", "Garden City Beach Pavilion", "Marlin Quay Marina"],
  localAnecdote: "Many Garden City Beach families swing by Francesco's after a day at the pier -- nothing beats a hot slice of NY-style pizza after hours in the sun and surf.",
  testimonials: [
    {
      name: "Karen M.",
      location: "Garden City Beach",
      text: "We order from Francesco's every Friday after beach days. The pizza reminds me of what I grew up eating in Brooklyn!",
      rating: 5
    },
    {
      name: "David R.",
      location: "Garden City",
      text: "Best pizza on the Grand Strand, hands down. The calzones are incredible too.",
      rating: 5
    }
  ],
  keywords: ["pizza garden city beach", "pizza near garden city sc", "best pizza garden city beach", "pizza delivery garden city", "italian food garden city beach sc"]
};
