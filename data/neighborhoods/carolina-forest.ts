...
export const carolinaForestData: NeighborhoodData = {
  ...
  landmarks: ["Carolina Forest Recreation Center", "Tanger Outlets", "The Market Common nearby"],
  localAnecdote: "Carolina Forest HOA block parties and neighborhood cookouts regularly feature our catering -- our Pizza Party Package is a huge hit with the families here.",
  testimonials: [
    {
      name: "Heather W.",
      location: "Carolina Forest",
      text: "We order Francesco's for every birthday party. The kids love the pizza and the parents love the prices!",
      rating: 5
    },
    {
      name: "Dan C.",
      location: "Carolina Forest",
      text: "Best Italian food south of New York. We make the drive from Carolina Forest at least once a week.",
      rating: 5
    }
  ],
  keywords: ["pizza carolina forest sc", "pizza near carolina forest", "best pizza carolina forest", "italian food carolina forest", "pizza delivery carolina forest"]
};
