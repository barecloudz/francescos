...
export const woodfinData: NeighborhoodData = {
  ...
  areasServed: [
    "Downtown Woodfin",
    "Riverside Drive Woodfin",
    "Elk Mountain",
    "I-26 North corridor",
    "Weaverville Road area"
  ],
  landmarks: [
    "French Broad River Park (Woodfin)",
    "Woodfin Greenway",
    "I-26 North exits"
  ],
  ...
  testimonials: [
    ...
    },
    {
      name: "Jennifer K.",
      location: "Woodfin",
      text: "Authentic NY pizza delivered right to Woodfin! The crust is perfect and the delivery is surprisingly fast. Highly recommend!",
      rating: 5
    }
  ],
  keywords: [
    "pizza Woodfin NC",
    "best pizza Woodfin",
    "pizza delivery Woodfin",
    "pizza near me Woodfin",
    "NY pizza Woodfin",
    "Italian restaurant Woodfin",
    "pizza North Asheville Woodfin"
  ]
};
