...
export const northMyrtleBeachData: NeighborhoodData = {
  ...
  landmarks: ["Barefoot Landing", "Cherry Grove Pier", "Alabama Theatre"],
  localAnecdote: "Several North Myrtle Beach families order our catering packages for their annual beach reunions -- they say nothing brings the family together like a spread from Francesco's.",
  testimonials: [
    {
      name: "Robert P.",
      location: "North Myrtle Beach",
      text: "We discovered Francesco's on a day trip and now we order catering for every family event. Outstanding food!",
      rating: 5
    },
    {
      name: "Lisa K.",
      location: "Cherry Grove",
      text: "Authentic NY pizza is hard to find this far south, but Francesco's nails it every single time.",
      rating: 5
    }
  ],
  keywords: ["pizza north myrtle beach", "best pizza north myrtle beach sc", "ny pizza north myrtle beach", "italian food north myrtle beach", "pizza delivery north myrtle beach"]
};
