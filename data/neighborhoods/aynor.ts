...
export const aynorData: NeighborhoodData = {
  ...
  landmarks: ["Aynor Town Hall", "Aynor Harvest Hoe-Down grounds", "Highway 501"],
  localAnecdote: "Aynor families driving to the beach for the day make Francesco's their dinner stop on the way home -- our hot, fresh pizza is the perfect reward after a day in the sun.",
  testimonials: [
    {
      name: "Bobby G.",
      location: "Aynor",
      text: "Whenever we make the trip to the coast, Francesco's pizza is the highlight. Real New York quality!",
      rating: 5
    },
    {
      name: "Cindy T.",
      location: "Aynor",
      text: "We ordered Francesco's catering for our family reunion and it was a huge hit. Everyone wanted the number!",
      rating: 5
    }
  ],
  keywords: ["pizza aynor sc", "pizza near aynor south carolina", "best pizza aynor sc", "italian food aynor", "pizza delivery aynor sc"]
};
