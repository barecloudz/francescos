...
export const barefootResortData: NeighborhoodData = {
  ...
  landmarks: ["Barefoot Landing", "Barefoot Resort Golf Courses", "House of Blues"],
  localAnecdote: "Golf groups staying at Barefoot Resort love ordering our party platters for their evening get-togethers -- our Italian Feast catering package is a post-round favorite.",
  testimonials: [
    {
      name: "Phil R.",
      location: "Barefoot Resort",
      text: "Our golf group orders Francesco's every trip. Best pizza for a crew of hungry golfers!",
      rating: 5
    },
    {
      name: "Carol M.",
      location: "Barefoot Landing area",
      text: "We live near Barefoot Landing and Francesco's is our favorite pizza spot. Authentic and delicious.",
      rating: 5
    }
  ],
  keywords: ["pizza barefoot resort", "pizza near barefoot landing", "best pizza barefoot resort sc", "italian food barefoot landing", "pizza delivery barefoot resort"]
};
