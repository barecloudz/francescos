...
export const conwayData: NeighborhoodData = {
  ...
  landmarks: ["Coastal Carolina University", "Conway Riverwalk", "Horry County Museum"],
  localAnecdote: "Coastal Carolina University students and staff have made Francesco's a regular stop -- our lunch specials are a hit with the college crowd.",
  testimonials: [
    {
      name: "Brian F.",
      location: "Conway",
      text: "I'm a CCU professor and my students turned me on to Francesco's. Now I'm the one recommending it to everyone!",
      rating: 5
    },
    {
      name: "Nancy G.",
      location: "Conway",
      text: "We drive from Conway for the calzones alone. Nothing compares in Horry County.",
      rating: 5
    }
  ],
  keywords: ["pizza conway sc", "pizza near conway south carolina", "best pizza conway sc", "italian food conway sc", "pizza delivery conway sc"]
};
