...
export const hawCreekData: NeighborhoodData = {
  ...
  testimonials: [
    ...
    {
      name: "Steve L.",
      location: "Haw Creek area",
      text: "Authentic NY-style pizza delivered right to Haw Creek! The crust is perfect and they don't skimp on toppings. Love it!",
      rating: 5
    }
  ],
  keywords: [
    "pizza Haw Creek",
    "best pizza Haw Creek Asheville",
    "pizza delivery Haw Creek",
    "pizza near me Haw Creek",
    "NY pizza Haw Creek",
    "Italian restaurant Haw Creek",
    "pizza East Asheville Haw Creek"
  ]
};
