...
export const litchfieldBeachData: NeighborhoodData = {
  ...
  landmarks: ["Litchfield Beach & Golf Resort", "Brookgreen Gardens", "Waccamaw River"],
  localAnecdote: "Litchfield vacation renters frequently order our large party platters -- our catering packages are perfect for beach house groups of any size.",
  testimonials: [
    {
      name: "Susan C.",
      location: "Litchfield Beach",
      text: "We rent in Litchfield every summer and Francesco's is always our first stop. The pasta is as good as the pizza!",
      rating: 5
    },
    {
      name: "Tom B.",
      location: "Litchfield by the Sea",
      text: "Great food, fast pickup, friendly staff. Francesco's has become our neighborhood favorite.",
      rating: 5
    }
  ],
  keywords: ["pizza litchfield beach sc", "pizza near litchfield beach", "best pizza litchfield", "italian food litchfield beach", "pizza delivery litchfield beach"]
};
