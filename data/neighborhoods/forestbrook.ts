...
export const forestbrookData: NeighborhoodData = {
  ...
  landmarks: ["Forestbrook Middle School", "Waccamaw Community Hospital nearby", "SC-707 & US-17 interchange"],
  localAnecdote: "Forestbrook residents love that they're close enough to Francesco's to order and have hot pizza on the table in under 30 minutes -- it's become the neighborhood's unofficial pizza spot.",
  testimonials: [
    {
      name: "Kevin M.",
      location: "Forestbrook",
      text: "Living in Forestbrook, we're so close to Francesco's. It's ruined all other pizza for us -- nothing else compares!",
      rating: 5
    },
    {
      name: "Pam L.",
      location: "Forestbrook",
      text: "Quick, delicious, and authentic. Francesco's is our go-to for easy weeknight dinners.",
      rating: 5
    }
  ],
  keywords: ["pizza forestbrook sc", "pizza near forestbrook", "best pizza forestbrook sc", "italian food forestbrook", "pizza delivery forestbrook"]
};
