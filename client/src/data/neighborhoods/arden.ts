...
export const ardenData: NeighborhoodData = {
  ...
  areasServed: [
    ...
    "Brookstone",
    "Biltmore Park Town Square area",
    "Royal Pines",
    "Glen Bridge"
  ],
  landmarks: [
  ...
  testimonials: [
    ...
    },
    {
      ...
      text: "Delivery is always fast to our house in Arden. The Sicilian pizza is our family's Friday night tradition. Highly recommend!",
      rating: 5
    },
    {
      name: "Chris W.",
      location: "Fletcher",
      text: "Finally—real NY pizza in Arden! The garlic knots are incredible and the stromboli is loaded with flavor. This is our new spot.",
      rating: 5
    }
  ],
  keywords: [
    "pizza Arden NC",
    "best pizza Arden",
    "pizza delivery Arden",
    "pizza near me Arden",
    "NY pizza Arden NC",
    "Italian restaurant Arden",
    "pizza Hendersonville Road",
    "pizza Biltmore Park"
  ]
};
