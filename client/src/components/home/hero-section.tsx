  ...
  return (
    <section className="relative h-screen lg:h-[600px] bg-cover bg-center" style={{ backgroundImage: "url('/images/hero-bg.jpeg')" }}>
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center relative z-10 text-center">
        <img src="/images/logo.png" alt="Francesco's Pizza Kitchen Logo" className="w-[140px] md:w-[170px] mb-4" loading="eager" fetchpriority="high" />
        ...
        <p className="text-base md:text-lg text-white mb-6 max-w-2xl">
          Welcome to Francesco's Pizza Kitchen! For over 40 years, we've carried forward the flavors of our Sicilian heritage. Family traditions and recipes passed down by our Nonna, flavors seasoned with laughter, memories, and love.
        </p>
